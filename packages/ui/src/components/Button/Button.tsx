...
export function Button({
  ...
  const buttonKinds: Record<ButtonKind, string> = {
    ...
    secondary:
      "text-brand-600 border-brand-600 bg-white hover:border-brand-700 hover:text-brand-700 focus:border-brand-600 focus:text-brand-600 focus:bg-brand-100 disabled:opacity-50 disabled:text-brand-600 disabled:cursor-not-allowed",
    danger:
