...
export function Header({ onToggle }: HeaderProps) {
  return (
    <header className="bg-brand-600 h-20 py-5 px-2 sm:px-4 md:px-10 flex items-center justify-between gap-3 z-20">
      ...
      <div className="flex items-center gap-2">
        <div className="flex flex-col items-end">
          ...
          <p className="md:hidden text-body-sm text-brand-200 text-right">
