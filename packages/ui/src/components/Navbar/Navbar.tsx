    ...
    <aside
      ...
      <div className="flex h-full flex-col justify-between pt-25 py-4 px-2">
        <Button label={isOpen ? "Fechar" : ""} size="sm" icon={isOpen ? "MenuFoldLine" : "MenuUnfoldLine"}
            className="px-2! hidden sm:flex" onClick={onToggle} />

        <div className="space-y-6">
          <nav aria-label="Principal">
            <a key="Dashboard" href="/"
                className="flex items-center gap-3 rounded-md px-2 py-2 text-body-lg font-medium text-brand-100 transition-colors hover:bg-brand-700 mb-2">
